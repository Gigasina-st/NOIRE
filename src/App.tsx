...
function Footer({onHomeSection}:{onHomeSection?:(section:string)=>void}){const link=(section:string)=>(e:React.MouseEvent<HTMLAnchorElement>)=>{if(onHomeSection){e.preventDefault();onHomeSection(section)}};return <footer><div className="footer-top"><a className="wordmark" href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>NOIRÉ</a><p>A modern house for<br/>quietly remarkable things.</p><div className="footer-links"><div><span>SHOP</span><a href={onHomeSection?"/#shop":"#shop"} onClick={onHomeSection?link('shop'):undefined}>New arrivals</a><a href={onHomeSection?"/#collections":"#collections"} onClick={onHomeSection?link('collections'):undefined}>Collections</a><a href={onHomeSection?"/#shop":"#shop"} onClick={onHomeSection?link('shop'):undefined}>Accessories</a></div><div><span>HOUSE</span><a href={onHomeSection?"/#about":"#about"} onClick={onHomeSection?link('about'):undefined}>Our story</a><a href={onHomeSection?"/#journal":"#journal"} onClick={onHomeSection?link('journal'):undefined}>Journal</a><a href={onHomeSection?"/#about":"#about"} onClick={onHomeSection?link('about'):undefined}>Stockists</a></div><div><span>CARE</span><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>Shipping & returns</a><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>Contact</a><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>FAQ</a></div></div></div><div className="footer-bottom"><span>© 2026 NOIRÉ PARIS</span><div><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>Instagram</a><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>Pinterest</a><a href={onHomeSection?"/#top":"#top"} onClick={onHomeSection?link('top'):undefined}>Legal</a></div><span>Made with intention.</span></div></footer>}
...
function ProductPage({product,back}:{product:Product;back:()=>void}){
  ...
  return <main className="product-page">
    <div className="product-page-top">
      <button className="collection-close" onClick={back}><ArrowLeft size={17}/> Back to home</button>
